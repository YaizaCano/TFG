...
const getDomainsVoters = async(req, res, next) => {
    const urls = await myContract.methods.getDomainList().call().catch(console.error);
    const voters = await myContract.methods.getVotersList().call().catch(console.error);
...
module.exports.getDomainsVoters = getDomainsVoters;